...
function TermWiseFinalResultConfig(props) {
          ...
          marksCardInformation.available_exam_list.map((sub, subIndex) => {
            ...
            Object.keys(subject.exam_test_list).map(
              (exam_test, examTestIndex) => {
                ...
                if (!subject.is_marks) {
                  ...
                  if (subject.selectedExamForGrade === sub.id) {
            ...
            if (
              ...
              if (
                ...
                if (
                  !isObjectEmpty(exam_test_temp) &&
                  (subject.exam_test_list[sub.id].is_marks ||
                    (!subject.exam_test_list[sub.id].is_marks &&
                      subject.selectedExamForGrade === sub.id))
                ) {
...
export default withRouter(TermWiseFinalResultConfig);
