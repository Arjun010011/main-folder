...
class ListAuthors extends Component {
  constructor() {
    super();
    this.permission = updatePermissions("library_authors", [
      "update",
      "delete",
    ]);
    this.state = {
              ...
              return (
                <div>
                  <ActionColumn
                    ...
                    deleteUrl={DEL_URL.libraryauthor.api}
  ...
  getCategoryTypeList = () => {
    ...
    let url = GET_URL.libraryauthor.api;
            ...
            <Grid container>
              <Grid item md={7} xs={12} sm={12}>
                <div className="header-align heading">
                  <FormattedMessage {...messages.libAuthors} />
                </div>
              </Grid>
              <Grid item md={5} xs={12} sm={12}>
                <div className="end-flex-prop header-align">
                  {isUserHasPermission("library_authors", "create") && (
                    <Button
                      variant="contained"
                      component={Link}
                      to={Actions.library_authors.create.url}
                      className="editbutton-view"
                    >
                      <AddCircleOutlineOutlinedIcon className="visibility-icon" />{" "}
                      {Actions.library_authors.create.label}
                    </Button>
                  )}
                </div>
              </Grid>
...
export default withRouter(ListAuthors);
