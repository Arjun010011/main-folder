...
class AddPublisher extends Component {
  ...
  postMethod = (categoryType) => {
    let post_data = {
      publisher: categoryType,
    };
    this.setState({ submitDisable: true });
    let url = POST_URL.librarypublisher.api;
    ...
    return (
      <div>
        <MultipleAdd
          ...
          header={<FormattedMessage {...messages.libPublisher} />}
          name={Actions.library_publisher.view.label}
          viewUrl={Actions.library_publisher.view.url}
...
export default withRouter(AddPublisher);
