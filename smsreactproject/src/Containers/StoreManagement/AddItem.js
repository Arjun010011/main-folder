...
const fieldDetails = [
    {
        ...
        regex: null, autoFocus: false, name: 'name', md: 6, maxLength: '50',
        className: 'width-80', required: true, id: 'outlined-textarea', default: '',
        rows: null, type: 'text'
    },
    {
        label: <FormattedMessage {...messages.storeItemCode} />,
        regex: null, autoFocus: false, name: 'code', md: 6, maxLength: '50',
        className: 'width-80', required: true, id: 'outlined-textarea', default: '',
        rows: null, type: 'text'
    },
]
        ...
        postRequest(url, post_data, this.props)
            .then((response) => {
                if (response && response.status === 200) {
                    ...
                    this.props.history.push(Actions.store_inventory_item.view.url)
                }
        ...
        return (
            <div>
                <MultipleAdd
                    ...
                    header={<FormattedMessage {...messages.addItemHeading} />}
                    subheader={<FormattedMessage {...messages.addItemSubHeading} />}
                    name={Actions.store_inventory_item.view.label}
                    viewUrl={Actions.store_inventory_item.view.url}
                    ...
                    idFormat={'item_add_2022_08_11_3_pm_'}
                />
            </div>
        )
    }
