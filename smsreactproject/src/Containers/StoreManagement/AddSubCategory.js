...
class AddSubCategory extends Component {
    ...
    postMethod = (subCategory) => {
        ...
        let url = POST_URL.subcategory.api;
        let post_data = {
    ...
    viewUrl = () => {
        let searchState = { category: this.state.category, categoryId: this.state.categoryId }
        let searchParam = "?" + new URLSearchParams(searchState).toString()
        this.props.history.push({
            pathname: Actions.store_inventory_subcategory.view.url,
            search: searchParam,
        });
    }
        ...
        return (
            <div>
                <MultipleAdd
                    ...
                    header={<FormattedMessage {...messages.storeSubCategoryType} values={category} />}
                    subheader={<FormattedMessage {...messages.addSubCategorySubHeading} />}
                    name={Actions.store_inventory_subcategory.view.label}
                    viewUrl={Actions.store_inventory_subcategory.view.url}
