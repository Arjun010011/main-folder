...
class AddItemsOnPurchase extends Component {
    constructor(props) {
        super(props)
    ...
    getAmount = () => {
        let { quantity, unitPrice, amount, fieldErrors } = this.state
        let validate = true
        if (quantity || unitPrice) {
            if (parseInt(quantity) < 0) {
                validate = false
                amount = ''
                fieldErrors['quantity'] = 'Invalid Amount'
            }
            if (parseInt(unitPrice) < 0) {
                validate = false
                amount = ''
                fieldErrors['unitPrice'] = 'Invalid Amount'
            }
        }
        if (validate) {
                                            ...
                                            <Grid container spacing={2} >
                                                ...
                                                <Grid item md={6} xs={12}>
                                                    <TextField
                                                        ...
                                                        required={true}
                                                        variant="outlined"
                                                        helperText={fieldErrors['unitPrice'] === '' ? helperText['unitPrice'] : fieldErrors['unitPrice']}
                                                        error={fieldErrors['unitPrice']}
                                                        onChange={(e) => this.handleUnitPriceChange(e)}
                                                    />
                                                </Grid>
                                                <Grid item md={6} xs={12}>
                                                    <TextField
                                                        ...
                                                        required={true}
                                                        variant="outlined"
                                                        helperText={fieldErrors['amount'] === '' ? helperText['amount'] : fieldErrors['amount']}
...
export default withRouter(AddItemsOnPurchase)
