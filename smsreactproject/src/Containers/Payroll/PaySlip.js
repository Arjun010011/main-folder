...
import { dateFormat, getFullName, numberWithCommasWithoutSymbol, getUrlParam } from 'Includes/functions';
...
class PaySlip extends Component {
    constructor(props) {
        ...
        let {staff_id} = currentSelectedList
        this.state = {
            monthList: [],
            loading: true,
            staff_id: staff_id,
    ...
    payslip = () => {
        ...
        let params = { staff: staff_id, salary_month: month, financial_year: year };
    ...
    handleDownload = () => {
        ...
        let {year} = getUrlParam();
        getRequest(GET_URL.payslip.api + staff_id + '/', { salary_month: month, financial_year: year}, prop).then(response => {
            if (response && response.status === 200) {
                    ...
                    <Grid container>
                        ...
                        <Grid item md={4} xs={12} >
                            <Box className='header-align end-flex-prop'>
                                <Button
                                    variant='contained'
                                    component={Link} to={Actions.payroll_payslipstafflist.view.url}
                                        ...
                                        <div>
                                            <table style={{ width: "100%" }}>
                                                ...
                                                <tr bgcolor="#C9D7DE">
                                                    ...
                                                    <td className="label-text-align">{payslipDetails.data.lop_days}</td>
                                                </tr>
                                                <tr bgcolor="#C9D7DE">
                                                    ...
                                                    <td className="label-text-align">{payslipDetails.data.present_days}</td>
                                                </tr>
                                                <tr bgcolor="#C9D7DE">
