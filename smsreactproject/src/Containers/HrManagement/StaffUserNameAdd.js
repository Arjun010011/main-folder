...
class StaffUserNameAdd extends Component {
  constructor(props) {
    super(props);
  ...
  handleViewButton = () => {
    this.props.history.push({
      pathname: Actions.staff_usernames.view.url,
    });
  };
          ...
          <Paper className="paper-background">
            <Grid container>
              <Grid item md={8} xs={12} className="header-align">
                <Box className="heading">Staff User Names</Box>
              </Grid>
              <Grid item md={4} xs={12}>
                <Box className="header-align end-flex-prop">
                  {isUserHasPermission("staff_usernames", "view") && (
                    <Button
                      variant="contained"
                    ...
                    >
                      ...
                      {Actions.staff_usernames.view.label}
                    </Button>
                  )}
                </Box>
              </Grid>
...
export default withRouter(StaffUserNameAdd);
