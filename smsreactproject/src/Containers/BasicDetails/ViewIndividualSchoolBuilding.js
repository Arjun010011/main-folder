...
class ViewIndividualSchoolBuilding extends Component {
    ...
    updateExpenseView = () => {
        ...
        let shift = {
            'sub_heading': '',
            'data': [{ label: 'Building Name', value: buildingDetails['name'] }, 
    ...
    handleEdit = () => {
        ...
        this.props.history.push({
            pathname: Actions.school_building.update.url,
...
export default withRouter(withStyles(Styles)(ViewIndividualSchoolBuilding));