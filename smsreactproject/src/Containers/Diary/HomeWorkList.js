...
class HomeWorkList extends Component {
    ...
    componentDidMount = () => {
        ...
        if (Actions.diary_managehomework_evaluate_list.view.url === this.props.location.pathname) {
            currentTab = 'Evaluation'
        }
        else if (Actions.diary_managehomework_completed_list.view.url === this.props.location.pathname) {
            ...
            (response) => {
                if (response && response.status === 200) {
                    ...
                    this.setState({
                        ...
                        if (Actions.diary_managehomework.create.url === this.props.location.pathname) {
                            this.createEditHomeWorkRef.current.handleClickOpen()
                        }
                        else if (Actions.diary_managehomework.update.url === this.props.location.pathname) {
                            if (id) {
    ...
    handleNavigateCreate = () => {
        ...
        this.props.history.push({
            pathname: Actions.diary_managehomework.create.url,
            search: searchParam,
        });
    }
    ...
    changeTab = (name) => {
        ...
        if (name === 'Evaluation') {
            ...
            this.props.history.push({
                pathname: Actions.diary_managehomework.view.url,
                search: searchParam,
            });
        }
        else if (name === 'Completed') {
            this.props.history.push({
                pathname: Actions.diary_managehomework_completed_list.view.url,
                search: searchParam,
            });
        }
    };
    ...
    editHomeWork = (id) => {
        ...
        let searchParam = "?" + new URLSearchParams(sectionInformation).toString()
        this.props.history.push({
            pathname: Actions.diary_managehomework.update.url,
            search: searchParam,
        });
    }
                        ...
                        <Grid container>
                            ...
                            <Grid item md={6} xs={12} >
                                <Box className='header-align end-flex-prop'>
                                    {isUserHasPermission('diary_managehomework', 'create') &&
