                        ...
                        <Box className="homework-title">
                          <Box>
                            ...
                            <TextField
                              ...
                              name={"title"}
                              value={getHomeWork.title}
                              variant="filled"
                              disabled={true}
                            />
                          </Box>
                          <Box className="mt-20">
                            <SubjectIcon className="marign-top-text"></SubjectIcon>
                            <TextField
                              className="text-background"
                          ...
                          {getHomeWork?.document_details?.length !== 0 && (
                            <Box className="upload-document-logo mt-50 margin-bottom-25">
                              <label htmlFor="upload-pic text-bold">
                                Uploaded File(s)
                              </label>
                            </Box>
                          )}
                          {getHomeWork?.document_details?.map((data) => {
                            return (
                              <Box
                                key={data.document_details.id}
                                className="list-box-shadow pointer"
                                onClick={() =>
                                  this.openImageDetailsPopup(data)
                                }
                              >
                                <Box className="display-flex">
                                  {/* <img src={data.document_details.file} height="20px" /> */}
                                  {data.document_details.isImage ? (
                                    <img
                                      src={data.document_details.file}
                                      height="20px"
                                    />
                                  ) : (
                                    <i
                                  ...
                                  <Box mx={3}>
                                    {data.document_details.file_name}
                                  </Box>
                                </Box>
                              </Box>
                            );
