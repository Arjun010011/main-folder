  ...
  constructor() {
    ...
    this.state = {
      ...
      columns: [
        ...
        { name: 'rank', label: 'Rank', options: { filter: true, sort: true } },
        { name: 'student', label: 'Student', options: { filter: true, sort: true } },
        { name: 'total_marks', label: 'Total Marks', options: { filter: true, sort: true } },
