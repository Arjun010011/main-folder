                ...
                {tableMeta.rowData[2] ?
                  ...
                  <div>
                    <ActionColumn
                      ...
                      updateUrl={PUT_URL.addFeeType.api}
                      deleteType={this.deleteType}
                      deleteUrl={DEL_URL.addFeeType.api}
          ...
          <Paper className={"paper-background"}>
            <Grid container>
              <Grid item md={7} xs={12} sm={12}>
                <Box className="header-align heading">Fee Type</Box>
              </Grid>
                ...
                <Box className="end-flex-prop header-align">
                  {isUserHasPermission("fee_type", "create") && (
                    <Button
                      variant="contained"
                      component={Link}
                      to={Actions.fee_type.create.url}
                      className="editbutton-view"
                    >
                      <AddCircleOutlineOutlinedIcon className="visibility-icon" />{" "}
                      {Actions.fee_type.create.label}
                    </Button>
                  )}
                </Box>
              </Grid>
