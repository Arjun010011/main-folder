...
export default function UpdateFeePlan(props) {
    const [open, setOpen] = React.useState(false);
    const { id, name, updateType, index,amount,standard } = props;
    const [feeType, setFeeType] = React.useState(name)
    const [amt,setAmount] = React.useState(amount)
    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">{standard}</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        Please enter Values to update
          </DialogContentText>
                    <TextField
                        autoFocus
                        margin="dense"
