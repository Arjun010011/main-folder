              ...
              >
                ...
                <Box ml="auto" className="group-feetype-heading d-flex ">
                  <div className="ml-50 text-align-center">
                    <div>Total</div>
                    <div>{`${numberWithCommas(data.total_amount_local)}`}</div>
                  </div>
                  {parseInt(data.concession_amount) > 0 && (
                    <div className="ml-50 text-align-center">
                      <div>Concession</div>
                      <div>{`${numberWithCommas(data.total_discount)}`}</div>
                    </div>
                  )}
                              ...
                              <tr>
                                        ...
                                        !!!feetermData.sequence ? (
                                          <div>
                                            <Checkbox
                                              ...
                                              defaultChecked={is_amount_checked}
                                ...
                                <td className="text-align-right">
                                  {feetermData.is_amount
                                    ? numberWithCommas(feetermData.total_amount)
                                    : numberWithCommas(feetermData.rate_amount)}
                                </td>
                                {parseInt(data.concession_amount) > 0 && (
                                  <td className="text-align-right">
                                    {numberWithCommas(
