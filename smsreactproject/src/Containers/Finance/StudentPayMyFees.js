...
import StudentFeeCollection from "./StudentPayFeeDetail";
...
// import StudentMarksCard from "Containers/Student/Components/StudentMarksCard";
...
class StudentPayMyFees extends Component {
  constructor(props) {
    super(props);
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(StudentPayMyFees)
);
