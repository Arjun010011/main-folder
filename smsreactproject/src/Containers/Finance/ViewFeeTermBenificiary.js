...
class ViewFeeTermBenificiary extends Component {
    constructor() {
        super();
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let standardName = tableMeta.rowData[4]
                            const viewData = {
                                'redirectToUrl': Actions.fee_term_benificiary.create.url,
                                'params': {
                            ...
                            if (value && value[0] && value[0]['is_approved'] === "1") {
                                ...
                                return <Box color='red' className='font-weight-bold'>
                                    <FormattedMessage {...messages.viewFeeTermFeesNotApproved} />
                                </Box>
                            }
                        }
                    },
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ViewFeeTermBenificiary));