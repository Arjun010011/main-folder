...
class ViewFeeTerm extends Component {
    constructor() {
        super();
        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta) => {
                            let standardName = tableMeta.rowData[5]
                            return standardName
                        }
                    },
                },
                ...
                {
                    name: 'fee_types',
                    label: <FormattedMessage {...messages.viewFeeTermApproval} />,
                    options: {
                        filter: true,
                        sort: false,
                        customBodyRender: (value, tableMeta) => {
                            let standardId = tableMeta.rowData[0]
                            let totalAmount = tableMeta.rowData[2]
                            if (value && value[0] && value[0]['is_approved'] === "1") {
                                return <Box color='green' className='font-weight-bold'> <FormattedMessage {...commonMessages.approved} /></Box>
                            } else if (totalAmount > 0 ) {
                                return isUserHasPermission('approve_fee_plan', 'create') && <Button
                                    className='approve-button-finance font-weight-bold'
                                    variant="contained"
                                    color="primary"
                                    size="small"
                                    onClick={(e) => this.approve(standardId)
                                    }>
                                    <FormattedMessage {...commonMessages.approve} />
                                </Button>
                            } else {
                                return <Box color='red' className='font-weight-bold'> 
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            let standardName = tableMeta.rowData[5]
                            let totalAmount = tableMeta.rowData[2]
                            let feeTypes = tableMeta.rowData[3]
                            const viewData = {
                                'redirectToUrl': Actions.fee_term_individual.view.url, 'params': {
                                    year: this.state.year,
                                    standard: tableMeta.rowData[0], studentType: this.state.selectedType, standardName: standardName,
                                    academicYearName: this.state.yearName
                                }
                            };
                            if (feeTypes && feeTypes[0] && feeTypes[0]['is_approved'] === "1") {
                                return (<Box>
                                    <ActionColumn
                                        ...
                                        enabledActions={['view']}
                                        newEditData={{ 'redirectToUrl': Actions.fee_term.create.url, 
                                        'params': { year: this.state.year, standard: tableMeta.rowData[0],
                                        studentType: this.state.selectedType, standardName:standardName ,academicYearName: this.state.yearName} }}
                                ...
                                return (<Box>
                                    <ActionColumn
                                        ...
                                        fieldDetails={fieldDetails}
                                        baseClassName='action-basic-detail-width'
                                        enabledActions={this.permission.includes('create') ? ['view', 'update']: ['view']}
                                        newEditData={{
                                            'redirectToUrl': Actions.fee_term.create.url,
                                            'params': {
                                ...
                                return  <MoreHorizIcon className='disabled-button'/>
                            }
                        },
                    }
                },
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ViewFeeTerm));