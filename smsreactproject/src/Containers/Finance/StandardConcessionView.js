...
class StandardConcessionView extends Component {
    constructor() {
        super();
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            const viewData = {
                                'redirectToUrl': Actions.fee_concession_individual.view.url, 'params': {
                            ...
                            if (feeTypes && feeTypes[0] && feeTypes[0]['is_approved'] === "1") {
                                return (<Box>
                                    <ActionColumn
                                        ...
                                        enabledActions={['view']}
                                        newEditData={{ 'redirectToUrl': Actions.fee_standard_concession.create.url, 
                                ...
                                return (<Box>
                                    <ActionColumn
                                        ...
                                        newEditData={{
                                            'redirectToUrl': Actions.fee_standard_concession.create.url,
                                            'params': {
    ...
    getFeeTermPlan = () => {
        ...
        getRequest(GET_URL.feeplanconcession.api, params, this.props).then((response) => {
            if (response && response.status === 200) {
                ...
                data.forEach((temp, i) => {
                    ...
                    data[i].concessionAmount = 0;
                    if(temp?.concession_data?.concession_fee_plan_mapping){
                        temp.concession_data.concession_fee_plan_mapping.forEach((j) => {
                            data[i].concessionAmount += j.concession_amount;
                        })
                    }
                })
                this.setState({
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(StandardConcessionView));