...
import ReviewSurveyFormPage from "./ReviewSurveyFormPage";
import TabSetQuestionsSurveyForm from "./TabSetQuestionsSurveyForm";
import "../styles.scss";
import LoadingGif from "Components/LoadingGif";

import { withStyles } from "@material-ui/core/styles";
import { DragDropContext, Droppable, Draggable } from "react-beautiful-dnd";
import ReviewSummaryCreateSurveyForm from "Containers/SurveyForm/components/ReviewSummaryCreateSurveyForm";
import AfterFinalizedView from "./AfterFinalizedViewSurveyForm";
import Alert from "@material-ui/lab/Alert";
import NoticeBoardSurveyForm from "Containers/SurveyForm/components/NoticeBoardSurveyForm";
...
class CreateQuestionSurveyForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.ReviewSurveyFormPage = React.createRef();
    this.bulkRef = null;
  }
  ...
  handleReviewAndSubmit = () => {
    ...
    try {
      if (
        this.ReviewSurveyFormPage &&
        this.ReviewSurveyFormPage.current &&
        typeof this.ReviewSurveyFormPage.current.getDetails === "function"
      ) {
        const detailsFromChild = this.ReviewSurveyFormPage.current.getDetails();
    ...
    if (!review_details) {
      this.setState({
        openSnackBar: true,
        alertData:
          "Please fill survey form configuration (title/sections/receivers/dates) before review.",
      });
      return;
    }
...
export default withRouter(withStyles(styles)(CreateQuestionSurveyForm));
