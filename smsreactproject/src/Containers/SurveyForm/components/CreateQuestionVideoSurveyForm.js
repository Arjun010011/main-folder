...
import ReviewFeedBackFormPage from './ReviewSurveyFormPage';
import TabSetQuestionsFeedBackForm from 'Containers/FeedBackForm/components/TabSetQuestionsFeedBackForm';
import '../styles.scss';
...
import ReviewVideoFeedBackForm from 'Containers/FeedBackForm/components/ReviewVideoFeedBackForm';
import ReviewSummaryCreateFeedBackForm from 'Containers/FeedBackForm/components/ReviewSummaryCreateFeedBackForm';
import VideoFeedBackFormQuestionList from 'Containers/FeedBackForm/components/VideoFeedBackFormQuestionListWithTiming';
...
class CreateQuestionVideoFeedBackForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            questionList: [],
...
export default withRouter(withStyles(styles)(CreateQuestionVideoFeedBackForm))
