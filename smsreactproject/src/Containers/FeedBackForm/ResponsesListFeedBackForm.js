...
import EvaluateStudentFeedBackForm from './EvaluateStudentFeedBackForm';
...
class ResponsesFeedBackForm extends Component {
    constructor() {
        super()
    ...
    deleteStudent = (id) => {
        ...
        const url = DEL_URL.feedbackformresponse.api + id + '/'
    ...
    goToEvaluatePage = (form_code, student) => {
        ...
        this.props.history.push({
            pathname: Actions.evaluate_student_feedbackform.view.url,
            search: searchParam,
        });
    }
    ...
    getQuizList = (paginationProps) => {
        ...
        const url = GET_URL.feedbackformresponse.api
    ...
    evaluateAll = () => {
        Swal.fire({
            ...
            if (result.value) {
                ...
                let url = POST_URL.feedbackformevaluate.api;
...
export default withRouter(ResponsesFeedBackForm)
