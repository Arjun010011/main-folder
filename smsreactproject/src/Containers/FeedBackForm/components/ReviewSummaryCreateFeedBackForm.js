...
const ReviewSummaryCreateFeedBackForm = React.forwardRef((props, ref) => {
    ...
    React.useEffect(() => {
        set_reviewDetails((prev) => {
          ...
          if (isEdit) {
            console.log(feedbackFormDetails,'jiiii')
            updated = {
              ...updated,
    ...
    useImperativeHandle(ref, () => ({
        ...
        getDetails() {
            ...
            console.log(return_value,'returnnnnnn')
            return return_value;
        }
    }));
            ...
            {!loading &&
                <Grid container spacing={2}>
                    ...
                    <Tooltip enterDelay={400} enterNextDelay={400} placement='top-start'
                        ...
                        title="The feedback form is automatically evaluated based on the answers selected" followCursor>
                        <Grid item md={2} xs={12} className='set-question-align-text-center'>
...
export default ReviewSummaryCreateFeedBackForm;
