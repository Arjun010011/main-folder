...
import FeedBackFormListActions from './components/FeedBackFormListActions';
import StaffSummaryFeedBackForm from './StaffSummaryFeedBackForm';
...
class FeedBackFormList extends Component {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (<div>
                                <FeedBackFormListActions
                                    ...
                                    editURL={Actions.set_feedbackform.update.url}
                                    editExtraParams={{
    ...
    getQuizList = (paginationProps) => {
        ...
        let params = { ...pagination_params, academic_year: year, is_active: true, form_type:'FeedbackForm' };
    ...
    handleAddButton = () => {
        ...
        if (year) {
            ...
            this.props.history.push({
                pathname: Actions.set_feedbackform.create.url,
                search: searchParam,
            });
        }
        else if (!year) {
                    ...
                    <Grid container>
                        ...
                        <Grid item lg={6} md={3} xs={12} >
                            <Box className={classNames('header-align', 'end-flex-prop')}>
                                ...
                                >{Actions.set_feedbackform.create.label} <MoreVertIcon className='visibility-icon' /> </Button>}
                            </Box>
                        </Grid>
                    </Grid>
...
export default withRouter(FeedBackFormList)
