...
class CharacterCertificateList extends Component {
  constructor() {
    super();
              ...
              return (
                <div>
                  <Button
                    ...
                    onClick={() => this.StudyCertificate(tableMeta.rowData[7])}
                  >
                    <FormattedMessage {...messages.characterCertificate} />
                  </Button>
                </div>
              );
            },
  ...
  StudyCertificate = (student) => {
    ...
    this.props.history.push(
      Actions.character_certificate.view.url +
...
export default withRouter(CharacterCertificateList);
