...
class TcCertificateList extends Component {
  constructor() {
    super();
              ...
              return (
                <div>
                  <Button
                    ...
                    onClick={() => this.generateTcCertificate(tableMeta.rowData[7])}
                  >
                    <FormattedMessage {...messages.tcCertificate} />
                  </Button>
                </div>
              );
            },
  ...
  generateTcCertificate = (student) => {
    let { standard, section } = this.state;
    this.props.history.push(
      Actions.tc_certificate_issue.view.url +
...
export default withRouter(TcCertificateList);
